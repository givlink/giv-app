  ...
  <div class="Detail Main">
      ...
      <div class="Detail__box__header">
        <nuxt-link :to="`/users/${giv.user}`" class="Detail__box__header__user">
          <div class="Detail__box__header__user__icon">
            <b-img :src="`https://api-dev.giv.link${giv.receive_user.profile_image_path}`" class="Detail__box__header__user__icon__img" alt></b-img>
          </div>

          <div class="Detail__box__header__user__text">
            <p class="Detail__box__header__user__text__name">{{giv.receive_user.last_name}} {{giv.receive_user.first_name}}</p>
          </div>
        </nuxt-link>
    ...
    <div class="Detail__date">
      ...
      <p class="Detail__date__info">
        <img class="Detail__date__info__img" src="~/assets/image/calendar.png" alt="カレンダー">
        <span class="Detail__date__info__text">{{ giv.meetup_date | moment }}{{ giv.start_time}}〜{{giv.end_time}}</span>
      </p>
    </div>
    <div class="Detail__place">
      ...
      <div class="Detail__place__map">
        <iframe :src="`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.7272719155903!2d${giv.longitude}!3d${giv.latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188b5850e5a83f%3A0x70297507b32efce5!2z5riL6LC344OS44Kr44Oq44Ko!5e0!3m2!1sja!2sjp!4v1571947364891!5m2!1sja!2sjp`" width="100%" height="225" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
      </div>
      <div class="Detail__place__link">

        <a class="Detail__place__link__btn" :href="`https://www.google.co.jp/maps/@${giv.latitude},${giv.longitude},15z`">
          Google Mapで見る
        </a>
      </div>
    </div>
...
<script>
    ...
    export default {
        ...
        async asyncData({ app, params }) {
            if(params.id) {
                const baseUrl = process.env.baseUrl + '/me/giv/' + params.id;
