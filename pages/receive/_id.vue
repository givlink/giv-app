<template>
  <div class="Detail Main">
      ...
      <div class="Detail__box__header">
        <nuxt-link :to="`/users/${giv.user}`" class="Detail__box__header__user">
          ...
          <div class="Detail__box__header__user__text">
            <p class="Detail__box__header__user__text__name">{{giv.giv_user.last_name}} {{giv.giv_user.first_name}}</p>
          </div>
        </nuxt-link>
    ...
    <div class="ThanksCard" v-if="giv.status == 'finished' && giv.thanks_card == null">
      <nuxt-link :to="`/thanks?id=${giv.id}`" class="ThanksCard__btn">
        ThanksCard・画像を投稿する
      </nuxt-link>
    </div>
  </div>
