...
export default function PostListCard({ post }) {
  ...
  return (
    <div className='mx-1.5 max-w-xl md:mx-auto border border-gray-100 rounded-xl bg-white shadow'>
      ...
      <Link to={`/posts/${post.id}`}>
        {firstImage && (
          <SafeImage
            className='h-64 md:rounded w-full object-cover overflow-hidden mb-2'
